...
export default class MessageCollector {
    ...
    constructor(client: Client, guild: Guild, channel: Channel, filter: (msg: Message) => boolean, options: CollectorOptions) {
        ...
        this.client.on("MESSAGE_DELETE_BULK", (message: Message) => this.deleteMessage.call(this, message))
    ...
    private collectMessage(msg: Message) {
        ...
        this.client.removeListener("MESSAGE_DELETE_BULK", (message: Message) => this.deleteMessage.call(this, message))
